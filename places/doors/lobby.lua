...
MenuGroup:AddButton("Join Discord", function()
    ...
    Inviter.Join("https://discord.com/invite/2e6NkZp2Mx")
    Inviter.Prompt({
        name = 'MNHUB",
        invite = "https://discord.com/invite/2e6NkZp2Mx",
    })
end):AddButton("Copy Link", function()
    if setclipboard then
        setclipboard("https://discord.com/invite/2e6NkZp2Mx")
        Library:Notify("Copied discord link to clipboard!")
    else
        Library:Notify("Discord link: https://discord.com/invite/2e6NkZp2Mx", 10)
    end
end)
MenuGroup:AddButton("Unload", function() Library:Unload() end)

CreditsGroup:AddLabel("Developers:")
CreditsGroup:AddLabel("YASAKU-ADMIN")
